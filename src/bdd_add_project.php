...
if( isset($_POST['nom']) && isset($_POST['code']) && isset($_POST['client']) && isset($_POST['date_debut']) && isset($_POST['jours_vendus']) && isset($_POST['cout_projet'])){
    ...
    if (isset($_POST['RAF_reel'])){
        $req = $bdd->prepare('INSERT INTO projet(nom, code, client, date_debut, jours_vendus, cout_projet, RAF_reel) VALUES(:nom, :code, :client, :date_debut, :jours_vendus, :cout_projet, :RAF_reel)');
        $req->execute(array(
        'nom' => $_POST['nom'],
        'code' => $_POST['code'],
        'client' => $_POST['client'],
        ...
        $req = $bdd->prepare('INSERT INTO projet(nom, code, client, date_debut, jours_vendus, cout_projet, RAF_reel) VALUES(:nom, :code, :client, :date_debut, :jours_vendus, :cout_projet, 0)');
        $req->execute(array(
        'nom' => $_POST['nom'],
        'code' => $_POST['code'],
        'client' => $_POST['client'],
